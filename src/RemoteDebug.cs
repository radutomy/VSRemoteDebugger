...
namespace VSRemoteDebugger
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class RemoteDebug
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private RemoteDebug(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static RemoteDebug Instance{ get; private set; }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new RemoteDebug(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            const string title = "RemoteDebug";
